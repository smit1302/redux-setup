...
const OrderDelivered: React.FC<FormProps> = ({ data }) => {

    const dataKey = ["open_invoices", "total_amount", "net_amount", "member_discount", "promo_discount", "part_payments_received", "outstanding_amount", "total_payment_due", "less_than_30_days", "between_30_to_60_days", "between_60_to_90_days", "greater_than_90_days", "in_future",]
